...
## 
##################################################################################
echo "===========Welcome to PullRepAdminWhoSQTLogs.sh======================================"
...
then
        echo "Sybase Admin Who SQT transfer is active"
else
	echo "================YES we need to START UP the REP Admin Who SQT pulls!"
        . $BASEDIR/LMRepCommandRefresh.sh $EnvFileToUse ADMINWHOSQT
fi
echo "===========Goodbye FROM PullRepAdminWhoSQTLogs.sh======================================"
