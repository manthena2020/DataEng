...
## 
##################################################################################
echo "===========Welcome to PullAdminDiskSpaceLogs.sh======================================"
...
then
        echo "Sybase Admin Disk Space  transfer is active"
else
	echo "================YES we need to START UP the REP Admin Disk Space pulls!"
        . $BASEDIR/LMRepCommandRefresh.sh $EnvFileToUse ADMINDISKSPACE
fi
echo "===========Goodbye FROM PullAdminDiskSpaceLogs.sh======================================"
