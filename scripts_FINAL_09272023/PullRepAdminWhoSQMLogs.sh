...
## 
##################################################################################
echo "===========Welcome to PullRepAdminWhoSQMLogs.sh======================================"
...
then
        echo "Sybase Admin Who SQM Transfer is active"
else
	echo "================YES we need to START UP the REP Admin Who SQM pulls!"
        . $BASEDIR/LMRepCommandRefresh.sh $EnvFileToUse ADMINWHOSQM
fi
echo "===========Goodbye FROM PullRepAdminWhoSQMLogs.sh======================================"
